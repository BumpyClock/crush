...
- Use the Agent tool for all non-coding tasks. This is important to minimize context usage.
  - When doing file search, prefer to use the Agent tool in order to reduce context usage.
  - When doing research tasks prefer to use the Agent tool to do the research and summarize it's findings back to you
